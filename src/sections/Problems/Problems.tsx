...
const delay = [
  0.5, // 'Time-consuming manual tasks'
  0.5, // ''
  ...
  return (
    <Section>
      ...
      <Paragraph
        ...
        size="big"
        sx={{textAlign: 'center'}}
        dangerouslySetInnerHTML={{__html: m.problems.subTitle1}}
      />
      <Paragraph
        animate
        alt
        size="big"
        sx={{textAlign: 'center'}}
        dangerouslySetInnerHTML={{__html: m.problems.subTitle2}}
      />
      <Paragraph
        animate
        alt
        ...
        dangerouslySetInnerHTML={{__html: m.problems.subTitle3}}
      />
