...
export const m = {
  ...
  pricing_: {
    ...
    perWorkspace: `Plan applies for one workspace. A workspace is designed for a single mission or project.`,
    // workspaceIs: `A workspace is designed for a single mission or project.`,
    // workspaceBilledSplit: `Each workspace is separate. Capacity limits and prices apply per workspace. A workspace is better designed for one mission.`,
    starter: 'Starter',
    mission: 'Mission',
    impact: 'Scale',
